...
-(void)btnClick:(UIButton *)btn{
    ...
    CGFloat W = UIScreen.mainScreen.bounds.size.width / self.buttonsArray.count;
...
-(void)settingFrame{
    ...
    self.topLine.frame = CGRectMake(0, 0, UIScreen.mainScreen.bounds.size.width, 1);
