...
-(instancetype)init {
    return [self initWithFrame:CGRectMake(0, 0, APP_WIDTH, PhotoSelectorHeight)];
}
...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        _collectionView = [[UICollectionView  alloc]initWithFrame:CGRectMake(0, 2.5, APP_WIDTH, kPhotoSelectorItemHeight) collectionViewLayout:layout];
        ...
        _bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_collectionView.frame) + 2.5, APP_WIDTH, 45 + BOTTOM_BAR_HEIGHT)];
        ...
        _album.titleLabel.font = [UIFont systemFontOfSize:16];
        [_album setTitle:@"相册" forState:UIControlStateNormal];
        [_album setTitleColor:RGB_COLOR(241.0, 47.0, 84.0, 1.0) forState:UIControlStateNormal];
        ...
        _originalPhoto.titleLabel.font = [UIFont systemFontOfSize:16];
        [_originalPhoto setTitle:@"原图" forState:UIControlStateNormal];
        [_originalPhoto setTitleColor:RGB_COLOR(241.0, 47.0, 84.0, 1.0) forState:UIControlStateNormal];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setOnSelect:^(BOOL isSelected) {
        ...
        if(self.selectedData.count > 0) {
            ...
            [self.send setBackgroundColor:RGB_COLOR(241.0, 47.0, 84.0, 1.0)];
        }else {
            self.send.enabled = NO;
            [self.send setBackgroundColor:RGB_COLOR(230.0, 230.0, 230.0, 1.0)];
        }
    }];
    return cell;
}
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self){
        ...
        _coverLayer.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.6].CGColor;
