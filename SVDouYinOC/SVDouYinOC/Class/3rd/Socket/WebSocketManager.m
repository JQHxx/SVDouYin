...
-(instancetype)init {
    ...
    if(self) {
        ...
        // [BaseUrl stringByAppendingString:@"/groupchat"]
        NSURLComponents *components = [[NSURLComponents alloc] initWithURL:[NSURL URLWithString:BaseUrl] resolvingAgainstBaseURL:NO];
