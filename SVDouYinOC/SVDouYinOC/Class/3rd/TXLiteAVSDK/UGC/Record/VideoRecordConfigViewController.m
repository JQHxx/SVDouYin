...
@property (weak, nonatomic) IBOutlet UIButton *btn916;
...
- (void)viewDidLoad {
    ...
    [self setBtn:_btn916 selected:NO];
...
- (IBAction)onClick916:(id)sender {
    [self setBtn:_btn11 selected:NO];
    [self setBtn:_btn43 selected:NO];
    [self setBtn:_btn169 selected:NO];
    [self setBtn:_btn916 selected:YES];
    _videoConfig.videoRatio = VIDEO_ASPECT_RATIO_16_9;
}
